  ...
  const features = [
    {
      ...
      description: "Memproses dan mengenali berbagai jenis suara dalam waktu singkat menggunakan model AI yang ringan dan efisien",
      icon: "⚡",
      gradient: "from-purple-400 to-pink-400"
    },
    {
      title: "Multiple Sound Types",
      description: "Dapat mengenali berbagai jenis suara seperti musik, percakapan, alarm, dan suara lingkungan",
      icon: "🔊",
      gradient: "from-blue-400 to-cyan-400"
    },
    {
      title: "AI-Powered by Deep Learning",
      description: "Ditenagai deep learning dan neural networks dari data berskala besar untuk klasifikasi suara yang presisi dan adaptif",
      icon: "🤖",
      gradient: "from-green-400 to-emerald-400"
    },
    {
      title: "Pretrained & Ready-to-Use",
      description: "Model yang sudah dilatih pada jutaan data, bisa langsung digunakan tanpa perlu pelatihan ulang",
      icon: "📊",
    ...
    <>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center text-center pt-24 pb-32">
            ...
            <p className="max-w-3xl text-2xl text-gray-400 mb-12 leading-relaxed font-light">
              Kenali suara dalam rekaman audio secara <span className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">otomatis</span> dengan teknologi audio tagging yang 
              <span className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600"> cerdas dan efisien</span>.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl w-full">
              {stats.map((stat, index) => (
                <div key={index} className="text-center p-6 bg-white/20 backdrop-blur-sm rounded-2xl border border-white/30 hover:bg-white/30 transition-all duration-300">
                  <div className="text-3xl font-black text-purple-500 mb-2">{stat.number}</div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-20">
              <h2 className="text-5xl font-black text-gray-900 mb-6">
                Apa itu <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Audio Tagging</span>?
              </h2>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Audio tagging adalah proses otomatis untuk memberi label pada potongan audio berdasarkan jenis suara yang dikandungnya, seperti suara manusia, musik, atau bunyi lingkungan.
                  </p>
                </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Audio tagging membantu mengelola data suara secara otomatis, sehingga mempercepat proses pencarian dan analisis. Teknologi ini penting untuk berbagai bidang seperti keamanan, riset, dan pengembangan asisten suara.
                  </p>
                </div>

                <div className="flex flex-wrap gap-4">
                  {["Pelabelan Otomatis", "Deteksi Multi Suara", "Tahan Suara Bising", "Integrasi Mudah"].map((item, index) => (
                    <span key={index} className="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full text-sm font-semibold shadow-lg">
                      ✓ {item}
                    </span>
                  ))}
                </div>
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-blue-600 to-purple-700 p-10 rounded-3xl shadow-2xl text-white">
                  <h3 className="text-3xl font-bold mb-8 text-center">Pengaplikasian Audio Tagging</h3>
                  <div className="space-y-6">
                    {[
                      { icon: "🔫", title: "Keamanan Publik", desc: "Deteksi suara tembakan, ledakan, sirene" },
                      { icon: "🏙️", title: "Smart city & IoT", desc: "Pengawasan lingkungan audio" },
                      { icon: "🎬", title: "Multimedia Indexing", desc: "Pencarian suara dalam video/audio" },
                      { icon: "🦯", title: "Aplikasi Aksesibilitas", desc: "Membantu tunanetra dengan deskripsi suara sekitar" }
                    ].map((app, index) => (
                      <div key={index} className="flex items-center p-4 bg-white/10 backdrop-blur-sm rounded-2xl hover:bg-white/20 transition-all duration-300">
      ...
      <section id="features" className="relative py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-black text-gray-900 mb-6">
              Fitur <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">Unggulan</span>
            </h2>
            <p className="text-2xl text-gray-600 max-w-5xl mx-auto leading-relaxed">
              Teknologi berbasis PANN (Pretrained Audio Neural Networks) dengan model CNN14 dan dataset AudioSet untuk solusi deteksi suara yang akurat, cepat, dan mudah digunakan.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {features.map((feature, index) => (
              <div key={index} className="group relative">
                ...
                <div className={`relative bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 border-2 border-transparent hover:border-white group-hover:bg-gradient-to-br group-hover:${feature.gradient} group-hover:text-white`}>
      ...
      {/* Team Section */}
      <section id="team" className="relative py-24 bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-black text-gray-900 mb-6">
              Tim <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">Pengembang</span>
            </h2>
            <p className="text-2xl text-gray-600 max-w-5xl mx-auto leading-relaxed">
            Dikembangkan oleh Kelompok 4 – Kelas Deep Learning A, sebagai implementasi pembelajaran dalam mata kuliah terkait deteksi sound event
            </p>
            <div className="w-24 h-1 bg-gradient-to-r from-purple-600 to-pink-600 mx-auto mt-6 rounded-full"></div>
          </div>
      ...
      <section className="relative py-24 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 text-center">
          <h2 className="text-6xl font-black text-white mb-6">
            Siap Mencoba Teknologi <span className="text-yellow-300">Kami?</span>
          </h2>
          <p className="text-2xl text-blue-100 mb-12 max-w-3xl mx-auto leading-relaxed">
            Rasakan kemudahan mengenali dan memberi label suara secara otomatis dengan akurasi tinggi dan performa efisien
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link
              href="/demo"
              className="group inline-flex items-center px-12 py-6 text-2xl font-bold text-purple-600 bg-white rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-3xl"
            >
              Mulai Demo Sekarang
              <span className="ml-3 text-3xl group-hover:translate-x-2 transition-transform duration-300">🚀</span>
            </Link>
            <Link
              href="#about"
              className="inline-flex items-center px-12 py-6 text-2xl font-bold text-white border-3 border-white rounded-full hover:bg-white hover:text-purple-600 transition-all duration-300 transform hover:scale-105"
            >
              Pelajari Lebih Lanjut
            </Link>
          </div>
